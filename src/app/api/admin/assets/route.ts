...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const allowed = ['title', 'type', 'category', 'plan', 'tags', 'description', 'file_url', 'thumbnail_url', 'is_public', 'credit_cost', 'exclusive_price', 'price_tier', 'exclusive_owner', 'exclusive_sold_at', 'is_free']
